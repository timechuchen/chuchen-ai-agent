...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'AI导游大师是初晨AI超级智能体应用平台的专业导游顾问，帮你解答各种旅游问题，提供旅程建议'
    },
    {
      name: 'keywords',
      content: 'AI导游大师,导游顾问,旅游咨询,AI聊天,情感问题,初晨,AI智能体'
    }
  ]
})
...
const generateChatId = () => {
  return 'tourism_' + Math.random().toString(36).substring(2, 10)
}
...
onMounted(() => {
  ...
  // 添加欢迎消息
  addMessage('欢迎来到AI导游大师，请告诉我你的旅游困难，我会尽力给予帮助和建议。', false)
})
