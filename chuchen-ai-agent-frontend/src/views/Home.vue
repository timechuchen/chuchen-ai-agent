  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">初晨AI超级智能体</h1>
      </div>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/tourism-master')">
        <div class="card-glow"></div>
        <div class="app-icon tourism-icon">旅</div>
        <div class="app-info">
          <div class="app-title">AI导游大师</div>
          <div class="app-desc">智能导游顾问，帮你解答旅游烦恼</div>
        </div>
...
// 设置页面标题和元数据
useHead({
  title: '初晨AI超级智能体应用平台 - 首页',
  meta: [
    {
      name: 'description',
      content: '初晨AI超级智能体应用平台提供AI导游大师和AI超级智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI导游大师,AI助手,智能对话,初晨,AI超级智能体,首页'
    }
  ]
})
...
.tourism-icon {
  background: linear-gradient(135deg, #02ff36, #075eff);
  box-shadow: 0 0 20px rgba(151, 246, 6, 0.5);
}
